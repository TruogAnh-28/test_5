...
export function UserForm({
  ...
  const {
    userInputSchema, userUpdateSchema,
  } = createUserInputSchemas(t)

  const formSchema = props.isCreate ? userInputSchema : userUpdateSchema
  ...
  const form = useForm<UserInput>({
    ...
    defaultValues: {
      ...
      email: "",
      role_id: 2,
      password: props.isCreate ? tempPassword : "",
    },
    values: props.values,
  })
