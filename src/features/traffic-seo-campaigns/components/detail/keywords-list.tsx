// src/features/traffic-seo-campaigns/components/detail/keywords-list.tsx
import React, {
  useState,
} from "react"
...
import {
  KeywordLogsSheet,
} from "~/features/traffic-seo-campaigns/components/detail/keyword-logs-sheet"
import {
...
export const KeywordsList: React.FC<KeywordsListProps> = ({ keywords }) => {
  ...
  return (
    <React.Fragment>
      ...
      {/* Sheet Container for Keyword Logs */}
      <SheetsContainer
        content={
          [
            {
              accessorKey: "keyword-logs",
              children: () => (
                selectedKeyword && (
                  <KeywordLogsSheet
                    keywordId={selectedKeyword.keywordId}
                    keywordName={selectedKeyword.keywordName}
